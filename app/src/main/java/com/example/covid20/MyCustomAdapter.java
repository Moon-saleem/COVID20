...
import static com.example.covid20.CountryAffected.countryModelsList;
...
public class MyCustomAdapter extends ArrayAdapter<CountryModel> {
    ...
    public MyCustomAdapter(Context context, List<CountryModel> countryModelList) {
        ...
        super(context, R.layout.list_view_item, countryModelList);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_view_item,null,true);
    ...
    public Filter getFilter() {
        Filter filter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                CountryAffected.countryModelsList = (List<CountryModel>) results.values;
